...
FrMapa02.belongsTo(Skema, {
  foreignKey: "id_skema",
  as: "skema"
});

Skema.hasMany(FrMapa02, {
  foreignKey: "id_skema",
  as: "frMapa02"
});
...
User.hasOne(ProfileAsesor, {
  foreignKey: "id_user"
});

User.hasOne(ProfileAdmin, {
  foreignKey: "id_user"
});

User.hasOne(ProfileTuk, {
  foreignKey: "id_user"
});
...
ProfileAsesor.belongsTo(User, {
  foreignKey: "id_user",
  as: "user"
});

ProfileAdmin.belongsTo(User, {
  foreignKey: "id_user"
});

ProfileTuk.belongsTo(User, {
  foreignKey: "id_user"
});
...
Skkni.hasMany(UnitKompetensi, {
  foreignKey: "id_skkni"
});

UnitKompetensi.belongsTo(Skkni, {
  foreignKey: "id_skkni",
  as: "skkni"
});

Skema.hasMany(BiayaUji, {
  foreignKey: "id_skema"
});

BiayaUji.belongsTo(Skema, {
  foreignKey: "id_skema"
});
...
Skema.hasMany(KelompokPekerjaan, {
  foreignKey: "id_skema"
});

KelompokPekerjaan.belongsTo(Skema, {
  foreignKey: "id_skema"
});
...
Jadwal.hasMany(JadwalAsesor, {
  foreignKey: "id_jadwal"
});

JadwalAsesor.belongsTo(Jadwal, {
  foreignKey: "id_jadwal"
});

User.hasMany(JadwalAsesor, {
  foreignKey: "id_user"
});

JadwalAsesor.belongsTo(User, {
  foreignKey: "id_user",
  as: "asesor"
});
...
ProfileAsesor.hasMany(JadwalAsesor, {
  foreignKey: "id_user"
});

JadwalAsesor.belongsTo(ProfileAsesor, {
  foreignKey: "id_user",
  as: "profileAsesor"
});

User.hasMany(PesertaJadwal, {
  foreignKey: "id_user"
});

ProfileAsesi.hasMany(PesertaJadwal, {
  foreignKey: "id_user",
  sourceKey: "id_user",
  as: "pesertaJadwal"
});
...
PesertaJadwal.belongsTo(User, {
  foreignKey: "id_user",
  as: "user"
});

Jadwal.hasMany(PesertaJadwal, {
  foreignKey: "id_jadwal"
});

PesertaJadwal.belongsTo(Jadwal, {
  foreignKey: "id_jadwal",
  as: "jadwal"
});
...
Pembayaran.belongsTo(Skema, {
  foreignKey: "id_skema",
  as: "skema"
});

Skema.hasMany(Pembayaran, {
  foreignKey: "id_skema",
  as: "pembayaran"
});

Pembayaran.belongsTo(TujuanPembayaran, {
  foreignKey: "id_tujuan_transfer"
});
...
User.hasMany(BandingAsesmen, {
  foreignKey: "id_user"
});

BandingAsesmen.belongsTo(User, {
  foreignKey: "id_user",
  as: "user"
});

Jadwal.hasMany(BandingAsesmen, {
  foreignKey: "id_jadwal"
});

BandingAsesmen.belongsTo(Jadwal, {
  foreignKey: "id_jadwal"
});

Skema.hasMany(BandingAsesmen, {
  foreignKey: "id_skema"
});

BandingAsesmen.belongsTo(Skema, {
  foreignKey: "id_skema"
});
...
Skema.belongsToMany(Skkni, {
  through: SkemaSkkni,
  foreignKey: "id_skema",
  as: "skknis"
});

Skkni.belongsToMany(Skema, {
  through: SkemaSkkni,
  foreignKey: "id_skkni",
  as: "skemas"
});
...
User.hasMany(Surveillance, {
  foreignKey: "id_user"
});

Surveillance.belongsTo(User, {
  foreignKey: "id_user"
});

Skema.hasMany(Surveillance, {
  foreignKey: "id_skema"
});

Surveillance.belongsTo(Skema, {
  foreignKey: "id_skema"
});
...
BankSoal.hasMany(BankSoalPG, {
  foreignKey: "id_soal"
});

BankSoalPG.belongsTo(BankSoal, {
  foreignKey: "id_soal"
});

BankSoal.belongsTo(UnitKompetensi, {
  foreignKey: "id_unit"
});

UnitKompetensi.hasMany(BankSoal, {
  foreignKey: "id_unit"
});
...
Skema.belongsToMany(UnitKompetensi, {
  through: SkemaUnit,
  foreignKey: "id_skema",
  as: "unitKompetensiList"
});

UnitKompetensi.belongsToMany(Skema, {
  through: SkemaUnit,
  foreignKey: "id_unit",
  as: "skemaList"
});
...
HasilKeputusanAsesmen.belongsTo(PesertaJadwal, {
  foreignKey: "id_peserta",
  as: "peserta"
});

PesertaJadwal.hasMany(HasilKeputusanAsesmen, {
  foreignKey: "id_peserta",
  as: "hasilKeputusan"
});

HasilKeputusanAsesmen.belongsTo(Jadwal, {
  foreignKey: "id_jadwal",
  as: "jadwal"
});

Jadwal.hasMany(HasilKeputusanAsesmen, {
  foreignKey: "id_jadwal",
  as: "hasilKeputusan"
});

HasilKeputusanAsesmen.belongsTo(ProfileAsesor, {
  foreignKey: "id_asesor",
  targetKey: "id_user",
  as: "asesor"
});

ProfileAsesor.hasMany(HasilKeputusanAsesmen, {
  foreignKey: "id_asesor",
  sourceKey: "id_user",
  as: "hasilKeputusan"
});
