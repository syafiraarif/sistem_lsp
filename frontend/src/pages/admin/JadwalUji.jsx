    ...
    <div className="min-h-screen bg-[#FAFAFA] p-6 md:p-8">
      <div className="mx-auto flex max-w-7xl flex-col gap-6">
        ...
        <div className="grid grid-cols-2 gap-4 lg:grid-cols-4">
          <StatCard icon={<CalendarDays size={20} />} label="Total Jadwal" value={totalJadwal} />
          <StatCard icon={<BadgeCheck size={20} />} label="Status Open" value={totalOpen} />
          <StatCard icon={<Clock size={20} />} label="Sedang Berjalan" value={totalOngoing} />
          <StatCard icon={<ClipboardList size={20} />} label="Draft" value={totalDraft} />
        </div>

        {/* MERGED CARD: FILTER & TABLE */}
        <div className="overflow-hidden rounded-xl border border-[#071E3D]/10 bg-white shadow-sm">
          
          {/* Section: Table Header & Filter */}
