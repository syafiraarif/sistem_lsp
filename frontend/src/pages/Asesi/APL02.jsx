    ...
    return (
      <div className="min-h-screen bg-[#F8FAFC] flex items-center justify-center">
        <div className="bg-white rounded-[32px] border border-slate-100 shadow-sm p-10 text-center">
          ...
          <p className="text-[#071E3D] font-black text-lg">Memuat APL02</p>
            ...
            <div className="relative z-10 flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
              <div>
                ...
                <div className="mt-5 flex flex-wrap gap-3">
                  <InfoBadge label="ID Skema" value={id_skema || "-"} />
                  <InfoBadge label="ID Peserta" value={idPeserta || "-"} />
                  <InfoBadge label="ID APL02" value={apl02?.id_apl02 || "-"} />
                  <InfoBadge label="Status" value={apl02?.status || "Belum Dibuat"} />
                </div>
              </div>

              <div className="bg-[#071E3D] text-white rounded-[26px] p-5 min-w-[260px] relative overflow-hidden">
                      ...
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-sm font-medium mt-1">
                            Buat APL02, simpan penilaian per elemen, upload
                            bukti, lalu submit final.
                          </p>
                        </div>
                      </div>
                    </div>
                ...
                <div className="bg-[#071E3D] rounded-[30px] p-6 text-white relative overflow-hidden">
                  ...
                  <div className="relative z-10">
                    ...
                    <div className="space-y-3 mt-5">
                      ...
                      <SummaryItem
                        label="ID APL02"
                        value={apl02?.id_apl02 || "-"}
                      />
                      <SummaryItem
                        label="Elemen Terisi"
                        value={`${totalTerisi}/${totalElemen}`}
                      />
                      <SummaryItem
                        label="Status"
                        value={apl02?.status || "Draft Baru"}
                      />
                    </div>
                  </div>
                </div>
...
const ErrorAlert = ({ message }) => {
  return (
    <div className="mb-6 rounded-[24px] bg-red-50 border border-red-100 p-5 flex gap-3 items-start shadow-sm">
